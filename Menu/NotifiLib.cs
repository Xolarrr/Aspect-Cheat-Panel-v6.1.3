...
{
    [BepInPlugin("aspect.notficationlib", "Aspect - NotificationLib", "1.0")]
    public class NotifiLib : BaseUnityPlugin
    {
        ...
        public static int NoticationThreshold = 15; //Amount of notifications before they stop queuing up
        ...
        private static void Init()
        {
            ...
            Testtext.rectTransform.localPosition = new Vector3(-1.5f, -.9f, -.3f);
